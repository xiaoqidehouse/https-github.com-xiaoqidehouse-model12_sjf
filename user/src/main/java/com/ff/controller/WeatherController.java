...
public class WeatherController {
    ...
    // 接口请求Key
    public  String API_KEY = "3cce1a2ba8bf604a01aad20aa63400fd";
    ...
    public Result queryWeather(String cityName) {
        ...
        try {
            ...
            if (error_code == 0) {
                ...
                System.err.printf("天气：%s%n", realtime.getString("info"));
                System.err.printf("温度：%s%n", realtime.getString("temperature"));
                System.err.printf("湿度：%s%n", realtime.getString("humidity"));
                System.err.printf("风向：%s%n", realtime.getString("direct"));
                System.err.printf("风力：%s%n", realtime.getString("power"));
                System.err.printf("空气质量：%s%n", realtime.getString("aqi"));
